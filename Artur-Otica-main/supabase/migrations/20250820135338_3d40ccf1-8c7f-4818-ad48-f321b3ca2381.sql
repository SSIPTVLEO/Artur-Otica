...
create index idx_os_created_by on public.Ordem_Servico(created_by);
create index idx_receita_created_by on public.Receita(created_by);
create index idx_armacao_lente_created_by on public.Armacao_Lente(created_by);
create index idx_pagamento_created_by on public.Pagamento(created_by);
